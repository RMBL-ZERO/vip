...
add-ip() {
    ...
    git remote add origin https://github.com/RMBL-ZERO/permission
    git push -f https://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@github.com/RMBL-ZERO/permission.git &> /dev/null
    rm -rf /root/ipvps
    clear
...
del-ip() {
    rm -rf /root/ipvps
    git clone https://github.com/RMBL-ZERO/ipmini.git /root/ipvps/ &> /dev/null
    clear
...
echo -e ""
echo -e " $PURPLE Created By $NC $Lyellow @RMBL VPN"
echo -e "${Lred} ══════════════════════════════════════════${NC}"
echo ""
