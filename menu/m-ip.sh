...
uu=$(curl -sS https://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@github.com/RMBL-ZERO/permission.git &> /dev/null
   ) 
...
listuser=$(curl -sS https://raw.githubusercontent.com/RMBL-ZERO/permission/main/ipmini | grep $MYIP | awk '{print $2}')
superadmin=$(curl -sS https://raw.githubusercontent.com/RMBL-ZERO/permission/main/ipmini | grep $MYIP | awk '{print $7}')
uu=$(curl -sS uu=$(curl -sS https://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@github.com/RMBL-ZERO/permission.git &> /dev/null
)
