...
wget https://raw.githubusercontent.com/RMBL-ZERO/permission/main/ipmini &> /dev/null
...
git remote add origin https://github.com/RMBL-ZERO/permission.git &> /dev/null
git push -f https://${tokenscript}@github.com/RMBL-ZERO/permission.git &> /dev/null
else
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1│${NC}${COLBG1}          ${WH}• PREMIUM SUPER ADMIN •                ${NC}$COLOR1│ $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
...
sleep 1
REQIP=$(curl -sS https://raw.githubusercontent.com/RMBL-ZERO/permission/main/ipmini | awk '{print $4}' | grep $daftar)
...
git branch -M main &> /dev/null
git remote add origin https://github.com/RMBL-ZERO/permission &> /dev/null
git push -f https://${tokenscript}@github.com/RMBL-ZERO/permission &> /dev/null
sleep 1
d1=$(date -d "$exp" +%s)
d2=$(date -d "$hariini" +%s)
...
wget https://raw.githubusercontent.com/RMBL-ZERO/license/main/key &> /dev/null
clear
if [ "$superadmin" = "VIP" ]; then
x=1
while [ $x -le $mkey ]
...
git remote add origin https://github.com/RMBL-ZERO/license >/dev/null 2>&1
git push -f https://${tokenkey}@github.com/RMBL-ZERO/license >/dev/null 2>&1
echo -e "$COLOR1┌────────────────────────────────┐${NC}"
...
<code>◇━━━━━━━━━━━━━━◇</code>
<i>Tunggu 2Menit Dulu Lalu Masuk Lagi</i>
"'&reply_markup={"inline_keyboard":[[{"text":"🔥ɪɴsᴛᴀʟʟ sᴄʀɪᴘᴛ","url":"https://t.me/RMBL-ZERO"},{"text":"🔥 ʀᴇɴᴇᴡ sᴄʀɪᴘᴛ","url":"https://t.me/RMBL-ZERO/337"}]]}'
else
TEXT="
<code>◇━━━━━━━━━━━━━━◇</code>
<b>  🔱 Info License Key </b>
...
<code>◇━━━━━━━━━━━━━━◇</code>
<i>Tunggu 2Menit Dulu Lalu Masuk Lagi</i>
"'&reply_markup={"inline_keyboard":[[{"text":"🔥ɪɴsᴛᴀʟʟ sᴄʀɪᴘᴛ","url":"https://t.me/RMBL-ZERO/187"},{"text":"🔥 ʀᴇɴᴇᴡ sᴄʀɪᴘᴛ","url":"https://t.me/RMBL-ZERO/337"}]]}'
fi
curl -s --max-time $TIMES -d "chat_id=$CHATID&disable_web_page_preview=1&text=$TEXT&parse_mode=html" $URL >/dev/null
if [ ! -e /etc/tele ]; then
echo -ne
...
wget https://raw.githubusercontent.com/RMBL-ZERO/permission/main/ipmini &> /dev/null
clear
grep -E "$uu$listuser" "ipmini" >>/root/RMBL-ZERO/client
if [ "$superadmin" = "VIP" ]; then
...
REQIP=$(curl -sS https://raw.githubusercontent.com/RMBL-ZERO/permission/main/ipmini | grep $iprenew | awk '{print $4}')
...
name1=$(curl -sS https://raw.githubusercontent.com/RMBL-ZERO/permission/main/ipmini | grep $iprenew | awk '{print $2}') #name
exp=$(curl -sS https://raw.githubusercontent.com/RMBL-ZERO/permission/main/ipmini | grep $iprenew | awk '{print $3}') #exp
ivps1=$(curl -sS https://raw.githubusercontent.com/RMBL-ZERO/permission/main/ipmini | grep $iprenew | awk '{print $4}') #ip
trial=$(curl -sS https://raw.githubusercontent.com/RMBL-ZERO/permission/main/ipmini | grep $iprenew | awk '{print $5}') #ip
MYIP=$(curl -sS ipv4.icanhazip.com)
...
echo -e "$COLOR1 ${NC} [INFO] PM : https://t.me/"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌────────────────────── ${WH}BY${NC} ${COLOR1}───────────────────────┐${NC}"
echo -e "$COLOR1 ${NC}                ${WH}• $author •${NC}                 $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
