...
echo -e "$COLOR1║ ${WH} ${BLUE}• ${GREEN}SLOWDNS Domain      ${NC}= $NS"
...
echo -e "$COLOR1║ ${WH} ${BLUE}• ${GREEN}Clients Name        ${NC}= ${YELLOW}$Name ${NC}"
...
echo -e "$COLOR1║ ${WH} \033[0m ${Blue} $ssh1        $vma           $vla          $tra               $ssa   $NC    $COLOR1║ $NC"
echo -e "$COLOR1╚═════════════════════════════════════════════════╝${NC}"
...
echo -e "$COLOR1║ ${WH} ${BICyan}[${BIWhite}01${BICyan}]${RED} •${NC} ${YELLOW}SSH     ${GREEN}MENU    $NC  ${BICyan}[${BIWhite}6${BICyan}]${RED} • ${NC}${YELLOW}RESTART SERVICE $COLOR1║ $NC"
echo -e "$COLOR1║                                                 $COLOR1║ $NC"
echo -e "$COLOR1║ ${WH} ${BICyan}[${BIWhite}02${BICyan}]${RED} •${NC} ${YELLOW}VMESS   ${GREEN}MENU    $NC  ${BICyan}[${BIWhite}7${BICyan}]${RED} • ${NC}${YELLOW}REBOOT VPS $COLOR1║ $NC"
echo -e "$COLOR1║                                                 $COLOR1║ $NC"
echo -e "$COLOR1║ ${WH} ${BICyan}[${BIWhite}03${BICyan}]${RED} •${NC} ${YELLOW}VLESS   ${GREEN}MENU    $NC  ${BICyan}[${BIWhite}8${BICyan}]${RED} • ${NC}${YELLOW}UPDATE $COLOR1║ $NC"
echo -e "$COLOR1║                                                 $COLOR1║ $NC"
echo -e "$COLOR1║ ${WH} ${BICyan}[${BIWhite}04${BICyan}]${RED} •${NC} ${YELLOW}TROJAN  ${GREEN}MENU    $NC  ${BICyan}[${BIWhite}9${BICyan}]${RED} • ${NC}${YELLOW}SETTING $COLOR1║ $NC"
echo -e "$COLOR1║                                                 $COLOR1║ $NC"
echo -e "$COLOR1║ ${WH} ${BICyan}[${BIWhite}05${BICyan}]${RED} •${NC} ${YELLOW}RUNNING ${GREEN}MENU    $NC  ${BICyan}[${BIWhite}10${BICyan}]${RED} • ${NC}${YELLOW}BACKUP  $COLOR1║ $NC"
echo -e "$COLOR1║                                                 $COLOR1║ $NC"
echo -e "$COLOR1╚═════════════════════════════════════════════════╝${NC}"
